...
TOOLS = [
    ...
    },
    {
        ...
        "description": "Clone a GitHub repository onto the configured EC2 host over SSH, deploy its FastAPI app in Docker, and return the public URL. Connection settings can come from runtime env or be passed in the tool input.",
        "input_schema": {
            "type": "object",
            "properties": {
